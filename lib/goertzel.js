...
const GOERTZEL_ATTRIBUTES_1 = require("./constants/GOERTZEL_ATTRIBUTES");
const INITIAL_OPTIONS_1 = require("./constants/INITIAL_OPTIONS");
const util_1 = require("./util");
const { atan2, cos, sin, PI } = Math;
class Goertzel {
    constructor(options = INITIAL_OPTIONS_1.INITIAL_OPTIONS) {
        this.options = options;
        this.sampleRate = options.sampleRate || INITIAL_OPTIONS_1.INITIAL_OPTIONS.sampleRate;
        this.frequencies = options.frequencies || INITIAL_OPTIONS_1.INITIAL_OPTIONS.frequencies;
    ...
    refresh() {
        let i = 0;
        while (i < GOERTZEL_ATTRIBUTES_1.GOERTZEL_ATTRIBUTES_LENGTH) {
            let attr = GOERTZEL_ATTRIBUTES_1.GOERTZEL_ATTRIBUTES[i];
            this[attr] = {};
            i++;
        }
...
Goertzel.Utilities = util_1.default;
exports.default = Goertzel;
